...
docker exec birdnet-analyzer rclone sync \
    --config /config/rclone/rclone.conf \
    b2:spadefoot/spadefoot-1 /audio/inbox/spadefoot-1 >> /home/geoace/birdnet/logs/daily.log 2>&1
...
docker exec birdnet-analyzer python /custom_scripts/ingest_results.py >> /home/geoace/birdnet/logs/daily.log 2>&1
